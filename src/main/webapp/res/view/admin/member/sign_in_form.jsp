...
<section>
    <div class="section_wrap">
        <div class="article">
            <form action="<%= request.getContextPath().concat(AdminConfig.MEMBER_SIGN_IN_CONFIRM)%>" name="admin_signin_form" method="post">
                <table>
                    <tr>
                        <td>관리자 아이디</td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="button" value="로그인" onclick="adminSignInForm();">
